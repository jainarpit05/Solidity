...
contract PropertyTransfer {
    ...
    function allotProperty(address _verifiedOwner, string _propertyName, string _ownerName, string _ownerPhysicalAddress, uint _propertyCost) onlyOwner {
        ...
        propertiesOwner[_verifiedOwner][individualCountOfPropertyPerOwner[_verifiedOwner]++].ownerPhysicalAddress = _ownerPhysicalAddress;
    ...
    function transferProperty (address _from, address _to, string _propertyName, string _newOwnerName) public returns (bool ,  uint ) {
        ...
        if(checkOwner != 999999999 && propertiesOwner[_from][checkOwner].isSold == false) {
            ...
            propertiesOwner[_to][individualCountOfPropertyPerOwner[_to]].ownerPhysicalAddress = propertiesOwner[_from][individualCountOfPropertyPerOwner[_from]].ownerPhysicalAddress;
